...
var ImageGrid = React.createClass({
    ...
    recalculateGrid: function (id, width, height) {
        ...
        if (all(_imagesToShow, function (image) { return image.width && image.height; })) {
            ...
            indexForMaxDimensionImage = findIndex(_imagesToShow, image => image.id === maxDimensionImage.id)
