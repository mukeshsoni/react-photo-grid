...
class ReactPhotoGrid extends React.Component {
    ...
    constructor(props) {
        ...
        this.onResize = throttle(this.onResize.bind(this), 16.667)
        this.handleImageClick = this.handleImageClick.bind(this)
        this.recalculateGrid = this.recalculateGrid.bind(this)
    ...
    recalculateGrid(id, width, height) {
        ...
        if (
            ...
            if (
                _imagesToShow[indexForMaxDimensionImage][winner] <
                container[winner]
            ) {
                container[winner] =
                    _imagesToShow[indexForMaxDimensionImage][winner]
