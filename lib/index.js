...
var ReactPhotoGrid = /*#__PURE__*/function (_React$Component) {
  ...
  function ReactPhotoGrid(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "onResize", function () {
      _this.setState({
        containerWidth: _reactDom["default"].findDOMNode(_assertThisInitialized(_this)).offsetWidth,
        containerHeight: _reactDom["default"].findDOMNode(_assertThisInitialized(_this)).offsetWidth
      });
    });
  ...
  _proto.componentDidMount = function componentDidMount() {
    ...
    if (!this.props.gridSize) {
      this.setState({
        containerWidth: _reactDom["default"].findDOMNode(this).offsetWidth,
        containerHeight: _reactDom["default"].findDOMNode(this).offsetWidth
      });
  ...
  _proto.render = function render() {
    ...
    }, images, /*#__PURE__*/_react["default"].createElement("div", {
      style: {
        clear: "both"
      },
      __self: this,
...
ReactPhotoGrid.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  gridSize: _propTypes["default"].string,
  onImageClick: _propTypes["default"].func
} : {};
var _default = ReactPhotoGrid;
