...
/* harmony import */ var lodash_throttle__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(11);
...
var ReactPhotoGrid = /*#__PURE__*/function (_React$Component) {
  ...
  function ReactPhotoGrid(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "onResize", function () {
      _this.setState({
        containerWidth: react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.findDOMNode(_assertThisInitialized(_this)).offsetWidth,
        containerHeight: react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.findDOMNode(_assertThisInitialized(_this)).offsetWidth
      });
    });
  ...
  _proto.componentDidMount = function componentDidMount() {
    ...
    if (!this.props.gridSize) {
      this.setState({
        containerWidth: react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.findDOMNode(this).offsetWidth,
        containerHeight: react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.findDOMNode(this).offsetWidth
      });
...
ReactPhotoGrid.propTypes = {
  ...
  gridSize: prop_types__WEBPACK_IMPORTED_MODULE_2___default.a.string,
  onImageClick: prop_types__WEBPACK_IMPORTED_MODULE_2___default.a.func
};
/* harmony default export */ __webpack_exports__["default"] = (ReactPhotoGrid);
...
*/
var aa=__webpack_require__(0),n=__webpack_require__(6),r=__webpack_require__(7);function u(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!aa)throw Error(u(227));
